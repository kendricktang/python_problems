...
from bintree_algs.lowestcommonancestor import lca2 as lca
...
class TestLCA(unittest.TestCase):
    ...
    def test_singlecase(self):
        ...
        n1 = root.findnode(42)
        n2 = root.findnode(42)
        self.assertEqual(lca(root, n1, n2).val, 42)
    ...
    def test_node1isLCA(self):
        ...
        n1 = root.findnode(13)
        n2 = root.findnode(18)
        self.assertEqual(lca(root, n1, n2).val, 13)
    ...
    def test_node2isLCA(self):
        ...
        n1 = root.findnode(24)
        n2 = root.findnode(20)
        self.assertEqual(lca(root, n1, n2).val, 20)
    ...
    def test_verydifferentbranches(self):
        ...
        n1 = root.findnode(34)
        n2 = root.findnode(20)
        self.assertEqual(lca(root, n1, n2).val, 1)
